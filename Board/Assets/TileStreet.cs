...
public class TileStreet : Tile
{
    ...
    public override void landingAction()
    {
        ...
        if (color == "Station" || color == "Utilities")
        {
            this.ResetPrice();
        }
    ...
    void Update()
    {
        //if player owns this tile and passes to next turn
        ...
        //if player owns this tile and clicks upgrading
        ...
        //if player decides not to buy, calls auction
        ...
        //if player has to pay different owner
    ...
    //converts inout colour string to versions unity would understand
